package com.redscraf.wxjump.service.aop;

import com.google.common.base.Throwables;
import com.redscraf.wxjump.common.exception.ServiceException;
import com.redscraf.wxjump.common.vo.Response;
...
public class ServiceLogAspect {
     ...
     * @param joinPoint
     */
    @Before("execution(* com.redscraf.wxjump.service.component.*.*(..))")
    ...
    @Around("execution(* com.redscraf.wxjump.service.component.*.*(..))")
     ...
     * @param reponse
     */
    @AfterReturning(value ="execution(* com.redscraf.wxjump.service.component.*.*(..))",returning = "reponse")
